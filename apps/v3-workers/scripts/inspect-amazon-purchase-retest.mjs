...
const main='/Users/barry/apps/crawlv3-batch-a.UiA4dx',dir=process.argv[2]??'/Users/barry/apps/crawlv3-history-20260913/amazon-purchase-retest-10-20260914';
...
assert.equal(plan.productCount,10);const ids=plan.batches.map(b=>b.requestId);assert.equal(plan.batches.flatMap(b=>b.entries).length,10);assert.equal(new Set(ids).size,ids.length);
