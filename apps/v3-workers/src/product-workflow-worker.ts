...
async function main() {
  ...
  await workerProcess(new RoleRegistry("business", [
    ...
    { role: "dtc-brand-workflow", capability: "dtc.control", compatibility: "dtc-live-v1" },
    { role: "dtc-product-workflow", capability: "dtc.product-input", compatibility: "dtc-live-v1" },
