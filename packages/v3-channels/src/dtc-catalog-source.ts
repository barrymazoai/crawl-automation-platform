...
export class DtcCatalogSource{
 ...
 return CatalogPageSchema.parse({codec:'catalog-page/1',input:i,source,entries:selectedEntries(parsed.entries,this.policy.selectedUrls),nextCursor:next,completion:next?'more':'unknown',endEvidence:null});}
