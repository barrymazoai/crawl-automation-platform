...
export function readPurchaseDom(box:string,extra='',main='7.99'){
 ...
 const raw=runInNewContext(amazonCommerceDomExpression,{document,location:{origin:'https://www.amazon.com',href:'https://www.amazon.com/dp/B0GGVD471R'},URL,getComputedStyle:()=>({visibility:'visible'})});
