...
export class ResultError extends Error {
    constructor(readonly code: "RESULT.CONFLICT" | "RESULT.INCOMPLETE" | "RESULT.INTEGRITY" | "RESULT.UNAVAILABLE" | "RESULT.REGISTRATION_UNKNOWN" | "RESULT.NOT_DURABLE" | "RESULT.REGISTRY_UNAVAILABLE") { super(code); this.name = "ResultError"; }
}
