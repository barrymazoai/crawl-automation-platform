...
describe("nutrition-only product scope", () => {
  ...
  it.each([
    ...
    ["Silicea Nagelpflege", "Ein hochwertiges Kosmetikum für Nägel und Nagelhaut.", ["Vitalstoffe"]],
    ["Ur-Kristallsalz fein", "Naturreines Kristallsalz für die Küche.", ["Vitalstoffe"]],
    ["Canine DigestEnz", "A digestive product for dogs.", ["Veterinary"]],
  ...
  it("treats verified main ingredients as positive nutrition evidence", () => {
